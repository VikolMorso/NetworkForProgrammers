        ...
        <div className={s.main}>
            <nav className={s.nav}>
                <ul className={s.nav__menu}>
                    ...
                    <li className={s.link}><NavLink to="/Users" activeClassName={s.active}>Users</NavLink></li>

                    <li className={`${s.link} ${s.setting}`}><NavLink to="/Settings" activeClassName={s.active}>Settings</NavLink></li>
